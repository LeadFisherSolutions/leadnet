...
export class Metacom extends EventEmitter {
  ...
  httpCall(unit: string, ver: string): (methodName: string) => (args: object) => Promise<void>;
  socketCall(unit: string, ver: string): (methodName: string) => (args: object) => Promise<void>;
...
export class Transport {
  ...
  ip: string;
  constructor(console: Console, req: ClientRequest, target: ServerResponse | WebSocket);
...
export class Server {
  ...
  handleRequest(client: Client, transport: Transport, data: Buffer, application: object): void;
  hook(client: Client, proc: object, packet: CallPacket, verb: string, headers: object): Promise<void>;
