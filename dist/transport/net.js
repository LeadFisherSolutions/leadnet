import Writable from 'dist/streams/writable';
import EventEmitter from '../events';
import { CALL_TIMEOUT, PING_INTERVAL, RECONNECT_TIMEOUT, CONNECTIONS } from '../config/net.config';
...
export default class Net extends EventEmitter {
  ...
  createStream = (name, size) => new Writable(this, { type: 'stream', id: ++this.streamID, name, size });
  blobUploader = blob => blob.uploader(this.createStream(blob.name ?? 'blob', blob.size), blob);
